...
#define SYSTEM_PLIC_SYSTEM_I2C_1_IO_INTERRUPT SYSTEM_PLIC_USER_INTERRUPT_G_INTERRUPT
#endif

#ifdef SYSTEM_PLIC_SYSTEM_SPI_1_IO_INTERRUPT
#undef SYSTEM_PLIC_SYSTEM_SPI_1_IO_INTERRUPT
#define SYSTEM_PLIC_SYSTEM_SPI_1_IO_INTERRUPT SYSTEM_PLIC_USER_INTERRUPT_H_INTERRUPT
#endif
