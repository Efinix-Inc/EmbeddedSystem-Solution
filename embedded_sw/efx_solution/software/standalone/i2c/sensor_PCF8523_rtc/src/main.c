////////////////////////////////////////////////////////////////////////////////
// Copyright (C) 2013-5 Efinix Inc. All rights reserved.
...
void main() {
    bsp_init();
    bsp_printf("I2C_CTRL is disabled, please enable it to run this app. \r\n");
}
#endif
...
{
	bsp_init();
	bsp_printf("This example design supported in Ti375C529 only!!!\r\n");
}
