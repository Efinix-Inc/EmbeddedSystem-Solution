...
/****************************************************** SETUP ETHERNET LINK ********************************************************/
	...
	bsp_printf(" * Send from FPGA -> iperf.exe -c 192.168.31.55 -t 25 -i 1 -p 5001 -b 100M -l 1460\r\n\r\n");
	bsp_printf("[INFO] To perform bidirectional test (RX/TX):\r\n");
	bsp_printf(" * Mandatory step: Start server at PC -> iperf.exe -s -i 1\r\n");
	bsp_printf(" * Send from FPGA -> iperf.exe -c 192.168.31.55 -t 25 -i 1 -p 5001 -r -b 100M -l 1460\r\n");
