...
# PLL Constraints
#################
create_clock -period 5.0000 io_memoryClk
...
create_clock -period 5.0000 io_ddrMasters_0_clk
create_clock -period 10.0000 i_pixel_clk
create_clock -period 8.7000 cam_ck_CLKOUT
create_clock -period 100.0000 jtagCtrl_tck

#PLL Feedback
##################
#create_clock -period 10.0000 io_dmaClk
#create_clock -period 1.0000 io_systemClk
#create_clock -period 13.4680 hdmi_clk_fbmClk

# Exclusive Clock Group
set_clock_groups -exclusive -group {cam_ck_CLKOUT} -group {rgmii_rxc io_tseClk_90 io_tseClk} -group {io_memoryClk} -group {i_pixel_clk} -group {i_hdmi_clk_148p5MHz} -group {io_ddrMasters_0_clk} -group {sd_base_clk} -group {io_peripheralClk} -group {i_sys_clk_25mhz} -group {io_cfuClk} -group {jtagCtrl_tck}
...
#####################################
# create_clock -period <USER_PERIOD> [get_ports {mux_clk}]
...
set_input_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~1~942}] -max 0.414 [get_ports {i_cam_scl}]
set_input_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~1~942}] -min 0.276 [get_ports {i_cam_scl}]
set_output_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~2~942}] -max 0.263 [get_ports {o_cam_scl_oe}]
set_output_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~2~942}] -min -0.140 [get_ports {o_cam_scl_oe}]
set_input_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~2~945}] -max 0.414 [get_ports {i_cam_sda}]
set_input_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~2~945}] -min 0.276 [get_ports {i_cam_sda}]
set_output_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~1~944}] -max 0.263 [get_ports {o_cam_sda_oe}]
set_output_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~1~944}] -min -0.140 [get_ports {o_cam_sda_oe}]
...
############################
# set_clock_latency -source -setup <board_max + 1.907> [get_ports {io_dmaClk}]
# set_clock_latency -source -hold <board_min + 1.271> [get_ports {io_dmaClk}]
...
# set_clock_latency -source -setup <board_max + 1.907> [get_ports {hdmi_clk_fb}]
# set_clock_latency -source -hold <board_min + 1.271> [get_ports {hdmi_clk_fb}]
...
# set_clock_latency -source -setup <board_max + 0.828> [get_ports {i_sys_clk_25mhz}]
# set_clock_latency -source -hold <board_min + 0.552> [get_ports {i_sys_clk_25mhz}]
...
# set_clock_latency -source -setup <board_max + 0.828> [get_ports {sd_base_clk}]
# set_clock_latency -source -hold <board_min + 0.552> [get_ports {sd_base_clk}]
