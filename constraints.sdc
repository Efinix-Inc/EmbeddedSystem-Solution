...
set_input_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~399~1}] -max 3.508 [get_ports {io_usb_dm_read[2]}]
set_input_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~399~1}] -min 1.611 [get_ports {io_usb_dm_read[2]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~400~1}] -max 1.203 [get_ports {io_usb_dm_write[2]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~400~1}] -min -0.093 [get_ports {io_usb_dm_write[2]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~400~1}] -max 1.184 [get_ports {io_usb_dm_writeEnable[2]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~400~1}] -min -0.074 [get_ports {io_usb_dm_writeEnable[2]}]
set_input_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~400~2}] -max 3.508 [get_ports {io_usb_dm_read[3]}]
set_input_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~400~2}] -min 1.611 [get_ports {io_usb_dm_read[3]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~393~2}] -max 1.203 [get_ports {io_usb_dm_write[3]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~393~2}] -min -0.093 [get_ports {io_usb_dm_write[3]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~393~2}] -max 1.184 [get_ports {io_usb_dm_writeEnable[3]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~393~2}] -min -0.074 [get_ports {io_usb_dm_writeEnable[3]}]
...
set_input_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~331~1}] -max 3.508 [get_ports {io_usb_dp_read[2]}]
set_input_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~331~1}] -min 1.611 [get_ports {io_usb_dp_read[2]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~401~1}] -max 1.203 [get_ports {io_usb_dp_write[2]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~401~1}] -min -0.093 [get_ports {io_usb_dp_write[2]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~401~1}] -max 1.184 [get_ports {io_usb_dp_writeEnable[2]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~401~1}] -min -0.074 [get_ports {io_usb_dp_writeEnable[2]}]
set_input_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~405~964}] -max 3.602 [get_ports {io_usb_dp_read[3]}]
set_input_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~405~964}] -min 1.558 [get_ports {io_usb_dp_read[3]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~404~963}] -max 1.464 [get_ports {io_usb_dp_write[3]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~404~963}] -min -0.108 [get_ports {io_usb_dp_write[3]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~404~963}] -max 1.446 [get_ports {io_usb_dp_writeEnable[3]}]
set_output_delay -clock io_usbClk -reference_pin [get_ports {io_usbClk~CLKOUT~404~963}] -min -0.089 [get_ports {io_usb_dp_writeEnable[3]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {ddr_inst1_ARBURST_0[1] ddr_inst1_ARBURST_0[0]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {ddr_inst1_ARBURST_0[1] ddr_inst1_ARBURST_0[0]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {ddr_inst1_ARSIZE_0[2] ddr_inst1_ARSIZE_0[1] ddr_inst1_ARSIZE_0[0]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {ddr_inst1_ARSIZE_0[2] ddr_inst1_ARSIZE_0[1] ddr_inst1_ARSIZE_0[0]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {ddr_inst1_AWBURST_0[1] ddr_inst1_AWBURST_0[0]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {ddr_inst1_AWBURST_0[1] ddr_inst1_AWBURST_0[0]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {ddr_inst1_AWSIZE_0[2] ddr_inst1_AWSIZE_0[1] ddr_inst1_AWSIZE_0[0]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {ddr_inst1_AWSIZE_0[2] ddr_inst1_AWSIZE_0[1] ddr_inst1_AWSIZE_0[0]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {ddr_inst1_AWCACHE_0[3] ddr_inst1_AWCACHE_0[2] ddr_inst1_AWCACHE_0[1] ddr_inst1_AWCACHE_0[0]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {ddr_inst1_AWCACHE_0[3] ddr_inst1_AWCACHE_0[2] ddr_inst1_AWCACHE_0[1] ddr_inst1_AWCACHE_0[0]}]
...
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.625 [get_ports {ddr_inst1_BRESP_0[1] ddr_inst1_BRESP_0[0]}]
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min 1.750 [get_ports {ddr_inst1_BRESP_0[1] ddr_inst1_BRESP_0[0]}]
...
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.625 [get_ports {ddr_inst1_RRESP_0[1] ddr_inst1_RRESP_0[0]}]
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min 1.750 [get_ports {ddr_inst1_RRESP_0[1] ddr_inst1_RRESP_0[0]}]
...
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~1~121}] -max 1.890 [get_ports {ddr_inst1_CTRL_CKE[1] ddr_inst1_CTRL_CKE[0]}]
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~1~121}] -min 1.260 [get_ports {ddr_inst1_CTRL_CKE[1] ddr_inst1_CTRL_CKE[0]}]
...
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~1~121}] -max 1.890 [get_ports {ddr_inst1_CTRL_PORT_BUSY[1] ddr_inst1_CTRL_PORT_BUSY[0]}]
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~1~121}] -min 1.260 [get_ports {ddr_inst1_CTRL_PORT_BUSY[1] ddr_inst1_CTRL_PORT_BUSY[0]}]
...
set_input_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~1~942}] -max 2.131 [get_ports {i_cam_scl}]
...
set_input_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~2~945}] -max 2.131 [get_ports {i_cam_sda}]
...
# set_clock_latency -source -hold <board_min + 0.000> [get_ports {rgmii_rxc}]
# set_clock_latency -source -setup <board_max + 0.000> [get_ports {io_tseClk_90}]
# set_clock_latency -source -hold <board_min + 0.000> [get_ports {io_tseClk_90}]
