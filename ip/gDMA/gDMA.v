...
`define IP_UUID _f0e7e6c4b6db40149213c06d91925b21
...
// Component : EfxDMA_f0e7e6c4b6db40149213c06d91925b21
// Git hash  : d635fcee4db89d9fa3a753360d674063a0460437

`timescale 1ns/1ps

module EfxDMA_f0e7e6c4b6db40149213c06d91925b21 (
  ...
  EfxDMA_Core_f0e7e6c4b6db40149213c06d91925b21 core (
  ...
  EfxDMA_Apb3CC_f0e7e6c4b6db40149213c06d91925b21 withCtrlCc_apbCc (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_6_f0e7e6c4b6db40149213c06d91925b21 io_interrupts_buffercc (
    .io_dataIn  (core_io_interrupts[1:0]               ), //i
    .io_dataOut (io_interrupts_buffercc_io_dataOut[1:0]), //o
    .ctrl_clk   (ctrl_clk                              ), //i
    .ctrl_reset (ctrl_reset                            )  //i
  );
  EfxDMA_BmbSourceRemover_f0e7e6c4b6db40149213c06d91925b21 readLogic_sourceRemover (
  ...
  EfxDMA_BmbToAxi4ReadOnlyBridge_f0e7e6c4b6db40149213c06d91925b21 readLogic_bridge (
  ...
  EfxDMA_StreamFifo_3_f0e7e6c4b6db40149213c06d91925b21 readLogic_beforeQueue_fifo (
  ...
  EfxDMA_BmbSourceRemover_1_f0e7e6c4b6db40149213c06d91925b21 writeLogic_sourceRemover (
  ...
  EfxDMA_BmbWriteRetainer_f0e7e6c4b6db40149213c06d91925b21 writeLogic_retainer (
  ...
  EfxDMA_BmbToAxi4WriteOnlyBridge_f0e7e6c4b6db40149213c06d91925b21 writeLogic_bridge (
  ...
  EfxDMA_BsbUpSizerDense_f0e7e6c4b6db40149213c06d91925b21 inputsAdapter_0_upsizer_logic (
  ...
  EfxDMA_StreamFifoCC_f0e7e6c4b6db40149213c06d91925b21 inputsAdapter_0_crossclock_fifo (
  ...
  EfxDMA_StreamFifoCC_1_f0e7e6c4b6db40149213c06d91925b21 outputsAdapter_0_crossclock_fifo (
  ...
  EfxDMA_BsbDownSizerSparse_f0e7e6c4b6db40149213c06d91925b21 outputsAdapter_0_sparseDownsizer_logic (
  ...
  EfxDMA_BmbArbiter_f0e7e6c4b6db40149213c06d91925b21 interconnect_read_aggregated_arbiter (
  ...
  EfxDMA_BmbArbiter_1_f0e7e6c4b6db40149213c06d91925b21 interconnect_write_aggregated_arbiter (
...
module EfxDMA_BmbArbiter_1_f0e7e6c4b6db40149213c06d91925b21 (
  ...
  EfxDMA_StreamArbiter_1_f0e7e6c4b6db40149213c06d91925b21 memory_arbiter (
...
module EfxDMA_BmbArbiter_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_inputs_0_cmd_valid,
  output wire          io_inputs_0_cmd_ready,
  input  wire          io_inputs_0_cmd_payload_last,
  input  wire [0:0]    io_inputs_0_cmd_payload_fragment_opcode,
  ...
  assign _zz_io_output_cmd_payload_fragment_source = {memory_arbiter_io_output_payload_fragment_source,memory_arbiter_io_chosen};
  EfxDMA_StreamArbiter_f0e7e6c4b6db40149213c06d91925b21 memory_arbiter (
    .io_inputs_0_valid                    (io_inputs_0_cmd_valid                                    ), //i
    .io_inputs_0_ready                    (memory_arbiter_io_inputs_0_ready                         ), //o
    .io_inputs_0_payload_last             (io_inputs_0_cmd_payload_last                             ), //i
    .io_inputs_0_payload_fragment_source  (1'b0                                                     ), //i
...
module EfxDMA_BsbDownSizerSparse_f0e7e6c4b6db40149213c06d91925b21 (
...
module EfxDMA_StreamFifoCC_1_f0e7e6c4b6db40149213c06d91925b21 (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_3_f0e7e6c4b6db40149213c06d91925b21 popToPushGray_buffercc (
    .io_dataIn  (popToPushGray[4:0]                    ), //i
    .io_dataOut (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .clk        (clk                                   ), //i
    .reset      (reset                                 )  //i
  );
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_5_f0e7e6c4b6db40149213c06d91925b21 pushToPopGray_buffercc (
...
module EfxDMA_StreamFifoCC_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
  input  wire [31:0]   io_push_payload_data,
  input  wire [3:0]    io_push_payload_mask,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_2_f0e7e6c4b6db40149213c06d91925b21 popToPushGray_buffercc (
    .io_dataIn    (popToPushGray[4:0]                    ), //i
    .io_dataOut   (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .dat0_i_clk   (dat0_i_clk                            ), //i
    .dat0_i_reset (dat0_i_reset                          )  //i
  );
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_3_f0e7e6c4b6db40149213c06d91925b21 pushToPopGray_buffercc (
    .io_dataIn  (pushToPopGray[4:0]                    ), //i
    .io_dataOut (pushToPopGray_buffercc_io_dataOut[4:0]), //o
    .clk        (clk                                   ), //i
    .reset      (reset                                 )  //i
...
module EfxDMA_BsbUpSizerDense_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_valid,
  output wire          io_input_ready,
...
module EfxDMA_BmbToAxi4WriteOnlyBridge_f0e7e6c4b6db40149213c06d91925b21 (
  ...
  EfxDMA_BmbContextRemover_1_f0e7e6c4b6db40149213c06d91925b21 contextRemover (
...
module EfxDMA_BmbWriteRetainer_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_StreamFifo_1_f0e7e6c4b6db40149213c06d91925b21 io_input_cmd_fifo (
...
module EfxDMA_BmbSourceRemover_1_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
...
module EfxDMA_StreamFifo_3_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
...
module EfxDMA_BmbToAxi4ReadOnlyBridge_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_BmbContextRemover_f0e7e6c4b6db40149213c06d91925b21 contextRemover (
    .io_input_cmd_valid                     (io_input_cmd_valid                                         ), //i
    .io_input_cmd_ready                     (contextRemover_io_input_cmd_ready                          ), //o
    .io_input_cmd_payload_last              (io_input_cmd_payload_last                                  ), //i
    .io_input_cmd_payload_fragment_opcode   (io_input_cmd_payload_fragment_opcode                       ), //i
...
module EfxDMA_BmbSourceRemover_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_source,
...
module EfxDMA_BufferCC_6_f0e7e6c4b6db40149213c06d91925b21 (
...
module EfxDMA_Apb3CC_f0e7e6c4b6db40149213c06d91925b21 (
  ...
  EfxDMA_FlowCCUnsafeByToggle_f0e7e6c4b6db40149213c06d91925b21 flowCCUnsafeByToggle (
  ...
  EfxDMA_FlowCCUnsafeByToggle_1_f0e7e6c4b6db40149213c06d91925b21 flowCCUnsafeByToggle_1 (
...
module EfxDMA_Core_f0e7e6c4b6db40149213c06d91925b21 (
  ...
  EfxDMA_DmaMemoryCore_f0e7e6c4b6db40149213c06d91925b21 memory_core (
  ...
  EfxDMA_Aggregator_f0e7e6c4b6db40149213c06d91925b21 b2m_fsm_aggregate_engine (
...
module EfxDMA_StreamArbiter_1_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_inputs_0_valid,
...
module EfxDMA_StreamArbiter_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_inputs_0_valid,
  output wire          io_inputs_0_ready,
  input  wire          io_inputs_0_payload_last,
  input  wire [0:0]    io_inputs_0_payload_fragment_source,
...
module EfxDMA_BufferCC_5_f0e7e6c4b6db40149213c06d91925b21 (
...
//EfxDMA_BufferCC_4 replaced by EfxDMA_BufferCC_3_f0e7e6c4b6db40149213c06d91925b21

module EfxDMA_BufferCC_3_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire [4:0]    io_dataIn,
  output wire [4:0]    io_dataOut,
  input  wire          clk,
  input  wire          reset
...
module EfxDMA_BufferCC_2_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire [4:0]    io_dataIn,
  output wire [4:0]    io_dataOut,
  input  wire          dat0_i_clk,
  input  wire          dat0_i_reset
...
module EfxDMA_BmbContextRemover_1_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_cmd_valid,
  ...
  EfxDMA_StreamFifo_2_f0e7e6c4b6db40149213c06d91925b21 fifoFork_thrown_translated_fifo (
...
module EfxDMA_StreamFifo_1_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
  input  wire          io_push_payload_last,
...
module EfxDMA_BmbContextRemover_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_cmd_valid,
  output reg           io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_StreamFifo_f0e7e6c4b6db40149213c06d91925b21 fifoFork_thrown_translated_fifo (
    .io_push_valid           (fifoFork_thrown_translated_valid                            ), //i
    .io_push_ready           (fifoFork_thrown_translated_fifo_io_push_ready               ), //o
...
module EfxDMA_FlowCCUnsafeByToggle_1_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_valid,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_1_f0e7e6c4b6db40149213c06d91925b21 inputArea_target_buffercc (
...
module EfxDMA_FlowCCUnsafeByToggle_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_valid,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_f0e7e6c4b6db40149213c06d91925b21 inputArea_target_buffercc (
    .io_dataIn  (inputArea_target                    ), //i
    .io_dataOut (inputArea_target_buffercc_io_dataOut), //o
    .clk        (clk                                 ), //i
    .reset      (reset                               )  //i
...
module EfxDMA_Aggregator_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_input_valid,
...
module EfxDMA_DmaMemoryCore_f0e7e6c4b6db40149213c06d91925b21 (
...
module EfxDMA_StreamFifo_2_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
...
module EfxDMA_StreamFifo_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
...
module EfxDMA_BufferCC_1_f0e7e6c4b6db40149213c06d91925b21 (
...
module EfxDMA_BufferCC_f0e7e6c4b6db40149213c06d91925b21 (
  input  wire          io_dataIn,
  output wire          io_dataOut,
  input  wire          clk,
  input  wire          reset
