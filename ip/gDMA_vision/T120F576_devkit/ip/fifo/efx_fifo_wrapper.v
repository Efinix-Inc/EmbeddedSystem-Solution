...
`define IP_UUID _4ea05a6a8edf49609267e1bd88a35985
...
generate
        ...
        if (SYNC_CLK) begin
          ...
          always @ (posedge wclk or posedge wr_rst) begin
              if (wr_rst) begin
                 ...
                 rdata_xready <= wr_en_int & rd_empty_int;
              end
           end

           assign rd_empty = rd_empty_int | rdata_xready;
        end
        else begin
    ...
    // NIC
        ...
        assign rd_datacount_int = waddr_int - raddr_cntr_w;
    end
    else begin
