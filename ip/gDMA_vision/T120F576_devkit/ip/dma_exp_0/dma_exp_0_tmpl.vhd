...
port (
    ...
    dat1_i_clk : in std_logic;
    dat1_i_reset : in std_logic;
    dat0_o_clk : in std_logic;
    dat0_o_reset : in std_logic;
    dat1_i_tvalid : in std_logic;
    dat1_i_tready : out std_logic;
    dat1_i_tdata : in std_logic_vector(31 downto 0);
    dat1_i_tkeep : in std_logic_vector(3 downto 0);
    dat1_i_tdest : in std_logic_vector(3 downto 0);
    dat1_i_tlast : in std_logic;
    read_rresp : in std_logic_vector(1 downto 0);
    io_1_descriptorUpdate : out std_logic
);
end component dma_exp_0;

---------------------- End COMPONENT Declaration ------------
------------- Begin Cut here for INSTANTIATION Template -----
u_dma_exp_0 : dma_exp_0
port map (
    clk => clk,
    reset => reset,
